                ...
                i =
                    this.sources.length < 2
                        ...
                        : '\n\t\t\t<button id="#lightboxCarousel-'
                              ...
                              .concat(
                                  this.hash,
                                  '" data-bs-slide="prev">\n\t\t\t\t<span class="previtems"><img src="img/a.svg"></span>\n\t\t\t\t<span class="visually-hidden">Previous</span>\n\t\t\t</button>\n\t\t\t<button id="#lightboxCarousel-'
                              )
                              ...
                              .concat(this.hash, '" data-bs-slide="next">\n\t\t\t\t<span class="nextitems"><img src="img/a.svg"></span>\n\t\t\t\t<span class="visually-hidden">Next</span>\n\t\t\t</button>');
        ...
        createModal() {
            const t = document.createElement("template"),
                e = '\n\t\t\t<div class="modal lightbox fade" id="lightboxModal-'
                    ...
                    .concat(
                        this.settings.size,
                        '">\n\t\t\t\t\t<div class="modal-content border-0 bg-transparent">\n\t\t\t\t\t\t<div class="modal-body p-0">\n\t\t\t\t\t\t\t<button  class=" closebtn position-absolute" data-bs-dismiss="modal" aria-label="Close" style="z-index: 2; background: none;">'
                    )
                    .concat(
